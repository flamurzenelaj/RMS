...
import FoodDropdown from "./FoodDropdown.vue";
...
export default {
  ...
  methods: {
    ...
    //to dont close the profile menu when we click anywhere inside div(black box)
    toggleProfileMenu(e) {
  ...
  nav {
    ...
    .nav-links {
      ...
      .profile {
        ...
        //to remove pointer when we click initials of profile
        span {
          pointer-events: none;
        }
